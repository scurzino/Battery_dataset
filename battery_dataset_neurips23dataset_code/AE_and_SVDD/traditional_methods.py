...
def load_dataset(fold_num, train=True):
    ...
    ind_ood_car_dict -> '../five_fold_utils/ind_odd_dict.npz.npy'
    ind_ood_car_dict -> '../five_fold_utils/ind_odd_dict1.npz.npy'
    ind_ood_car_dict -> '../five_fold_utils/ind_odd_dict2.npz.npy'
    ind_ood_car_dict -> '../five_fold_utils/ind_odd_dict3.npz.npy'
    '''
...
if __name__ == '__main__':
    ...
    if args.method == 'auto_encoder':
        ...
        clf = bug_fixed_AutoEncoder(hidden_neurons=[64, 32, 32, 64], preprocessing=True, batch_size=128, epochs=10,
